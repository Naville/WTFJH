...
int SHA1_Update(SHA_CTX *c, const void *data, size_t len){
		...
		CallTracer *tracer = [[CallTracer alloc] initWithClass:@"OpenSSL/SHA1" andMethod:@"SHA1_Update"];
...
int SHA1_Final(unsigned char *md, SHA_CTX *c){
	...
	CallTracer *tracer = [[CallTracer alloc] initWithClass:@"OpenSSL/SHA1" andMethod:@"SHA1_Final"];
...
int SHA1(const unsigned char *d, size_t n, unsigned char *md){
	...
	NSMutableString *Hash = [NSMutableString string];
	for (int i=0; i<SHA1_DIGEST_SIZE; i++){[Hash appendFormat:@"%02x", md[i]];}
		CallTracer *tracer = [[CallTracer alloc] initWithClass:@"OpenSSL/SHA1" andMethod:@"SHA1"];
		[tracer addArgFromPlistObject:InputData withKey:@"InputData"];
		[tracer addArgFromPlistObject:Hash withKey:@"SHA1Hash"];
		[tracer addReturnValueFromPlistObject:[NSNumber numberWithInt: origResult]];
...
MSHookFunction(((void*)MSFindSymbol(NULL, "SHA1_Update")),(void*)SHA1_Update, (void**)&old_SHA1_Update);
MSHookFunction(((void*)MSFindSymbol(NULL, "SHA1_Final")),(void*)SHA1_Final, (void**)&old_SHA1_Final);
MSHookFunction(((void*)MSFindSymbol(NULL, "SHA1")),(void*)SHA1, (void**)&old_SHA1);

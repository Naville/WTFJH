export CFLAGS=-Wp,"-DWTFJHTWEAKNAME=@\"VI2C2SU2XWI4XM7\""
include theos/makefiles/common.mk
export ARCHS = armv7 armv7s arm64
export TARGET = iphone:clang:7.0:7.0
TWEAK_NAME = VI2C2SU2XWI4XM7
...
VI2C2SU2XWI4XM7_LIBRARIES = sqlite3 substrate
VI2C2SU2XWI4XM7_FRAMEWORKS = Foundation UIKit Security
